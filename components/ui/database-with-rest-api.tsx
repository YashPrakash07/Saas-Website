...
import { Mail, Users, SparklesIcon } from "lucide-react";
        ...
        >
            ...
            <div className="absolute bottom-10 flex w-full flex-col items-center">
                ...
                <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
                    {/* Badges */}
                    <div className="absolute bottom-8 left-8 sm:left-12 z-10 h-7 rounded-full bg-[#101112] px-3 text-xs border flex items-center gap-2 text-white">
                        <Users className="size-4" />
                        <span>{buttonTexts?.first || "Audiences"}</span>
                    </div>
                    <div className="absolute bottom-8 right-8 sm:right-16 z-10 hidden xs:flex h-7 rounded-full bg-[#101112] px-3 text-xs border items-center gap-2 text-white">
                        <Mail className="size-4" />
                        <span>{buttonTexts?.second || "Campaigns"}</span>
                    </div>
                    {/* Circles */}
                    <motion.div
